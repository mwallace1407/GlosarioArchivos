            ...
            try
            {
                ...
                if (firstTime)
                {
                    ...
                    SpreadsheetDocument spreadsheetDocument = SpreadsheetDocument.
                        Create(Path.Combine(RutaArchivos, fileName), SpreadsheetDocumentType.Workbook);
                ...
                else
                {
                    ...
                    var spreadsheetDocument = SpreadsheetDocument.Open(Path.Combine(RutaArchivos, fileName), true);
